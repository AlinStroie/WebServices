      ...
      <div className="relative">
        ...
        <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.045] p-5">
          ...
          <div className="mt-6 space-y-3">
            <MobileCheck text="secțiuni gândite logic" />
            <MobileCheck text="afișare bună pe telefon" />
            <MobileCheck text="formular și CTA vizibile" />
          </div>
        </div>

        <div className="mt-4 grid grid-cols-3 gap-3">
          <MobileStat value="5+" label="secțiuni" />
          <MobileStat value="100%" label="mobil" />
          <MobileStat value="SEO" label="basic" />
        </div>
      </div>
    </div>
  );
...
function DesktopHeroMockup() {
  return (
    <div className="relative">
      <div className="pointer-events-none absolute -inset-8 -z-10 rounded-[3rem] bg-white/[0.035] blur-[85px]" />

      <div className="relative overflow-hidden rounded-[2.25rem] border border-white/10 bg-[#0b0c10]/85 p-3 shadow-[0_24px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
        ...
        <div className="relative overflow-hidden rounded-[1.8rem] border border-white/10 bg-[#0e1015]">
          <div className="flex items-center justify-between border-b border-white/10 bg-[#11141b] px-5 py-4">
            ...
            <span className="rounded-full border border-white/10 bg-[#181b22] px-4 py-1.5 text-xs text-[#b1bac7]">
              project preview
            </span>
          </div>

          <div className="grid gap-4 p-6">
            <div className="rounded-[1.7rem] border border-white/10 bg-[linear-gradient(135deg,rgba(214,223,234,0.14),rgba(145,159,178,0.07))] p-6">
              <div className="flex items-start justify-between gap-5">
                ...
                <div className="h-14 w-14 shrink-0 rounded-full bg-[#eef3f8]" />
              </div>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-white/10 bg-[#131720] p-5">
              <div className="flex items-center justify-between">
                ...
                <p className="text-2xl font-semibold tracking-[-0.04em] text-[#eef3f8]">
                  94%
                </p>
              </div>
