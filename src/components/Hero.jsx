...
function Hero({ onOpenContact }) {
  return (
    ...
    >
      <div className="absolute left-1/2 top-20 -z-10 h-[34rem] w-[34rem] -translate-x-1/2 rounded-full bg-white/[0.06] blur-[120px]" />
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-6 -z-10 rounded-[3rem] bg-white/[0.06] blur-3xl" />
            ...
            <div className="rounded-[1.5rem] border border-white/10 bg-[#080808] p-4">
              ...
              <div className="grid gap-4">
                <div className="rounded-[1.4rem] border border-white/10 bg-gradient-to-br from-white/16 to-white/[0.02] p-6">
                  <p className="mb-14 text-sm text-white/45">
