        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              className="absolute left-[-3.7rem] top-1/2 z-40 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/15 bg-white text-black shadow-[0_18px_70px_rgba(0,0,0,0.65)] transition hover:scale-105 hover:bg-white/90 lg:flex"
            ...
            <div className="drawer-scroll relative flex-1 overflow-y-auto px-6 py-6 md:px-8">
              ...
              <form onSubmit={handleSubmit} className="rounded-[1.8rem] border border-white/10 bg-white/[0.025] p-5">
                ...
                >
                  ...
                  <span className="relative grid h-7 w-7 shrink-0 place-items-center rounded-full bg-black text-white transition duration-300 group-hover:rotate-45">
                    <Send size={14} strokeWidth={2.4} className="translate-x-[-1px] -translate-y-[-1px]" />
                  </span>
                </button>
              </form>
            ...
            <div className="relative border-t border-white/10 px-6 py-4 md:px-8">
              <div className="flex flex-col gap-4 text-sm sm:flex-row sm:items-center sm:justify-between">
                <p className="max-w-md text-white/35">
                  Datele sunt folosite doar pentru contactarea ta în legătură cu
                  proiectul.
                </p>
