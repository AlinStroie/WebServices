export const siteConfig = {
  ...
  hero: {
    eyebrow: "Design premium pentru afaceri moderne",
    title: "Construim site-uri moderne care arată bine și convertesc.",
    subtitle:
      "Realizăm website-uri rapide, responsive și optimizate pentru afaceri care vor o imagine profesională online.",
    primaryButton: "Vezi serviciile",
    secondaryButton: "Solicită ofertă",
  },
  ...
  privacy: {
    ...
    subtitle:
      "Această politică explică, într-un mod clar, ce date pot fi colectate prin intermediul site-ului, de ce sunt necesare și cum sunt folosite.",
    updatedAt: "Mai 2026",
    highlights: [
      ...
      "Site-ul poate folosi cookies necesare pentru funcționare și experiență de navigare.",
    ],
    sections: [
      {
        label: "01",
        ...
        content: [
          "Prin formularul de contact pot fi colectate date precum numele, adresa de email, numărul de telefon și mesajul transmis de tine.",
      ...
      },
      {
        ...
        content: [
          ...
          "În anumite situații, pot fi folosite servicii tehnice necesare funcționării site-ului, precum hosting, email sau instrumente de securitate. Acestea sunt folosite doar pentru funcționarea normală a site-ului.",
        ],
      },
      {
        label: "05",
        ...
        content: [
          ...
          "Pentru orice solicitare legată de datele personale, ne poți contacta folosind datele de contact afișate pe site.",
        ],
        points: [
    ...
    sections: [
      {
        ...
        content: [
          "Cookies sunt fișiere mici salvate în browserul tău atunci când vizitezi un site. Ele ajută site-ul să rețină anumite preferințe sau să funcționeze corect.",
          "Unele cookies sunt strict necesare, iar altele pot fi folosite pentru analiză, performanță sau personalizarea experienței.",
        ],
      },
      {
        label: "02",
      ...
      },
      {
        ...
        content: [
          "Poți șterge, bloca sau gestiona cookies din setările browserului folosit. De asemenea, poți reseta preferința pentru acest site prin ștergerea datelor locale ale browserului.",
