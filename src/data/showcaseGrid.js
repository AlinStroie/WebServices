...
export const showcaseTiles = [
  { id: "s01", label: "Cabinet kinetoterapie", kind: "Servicii medicale", from: "#0f3d3a", to: "#10b981", layout: "hero", src: "/images/portfolio-previews/movea-preview.png" },
  { id: "s02", label: "Salon beauty", kind: "Servicii beauty", from: "#3b1230", to: "#e896cd", layout: "grid", src: "/images/portfolio-previews/luna-beauty-studio-preview.png" },
  { id: "s03", label: "Firmă transport", kind: "Corporate", from: "#0b2a4a", to: "#2c7dff", layout: "dashboard", src: "/images/portfolio-previews/atlas-freight-preview.png" },
  { id: "s04", label: "Portofoliu personal", kind: "Personal brand", from: "#241a3a", to: "#7a5cff", layout: "editorial", src: "/images/portfolio-previews/andrei-crisan-design-preview.png" },
  { id: "s05", label: "Magazin online", kind: "E-commerce", from: "#123a1e", to: "#5fd08a", layout: "shop", src: "/images/portfolio-previews/vlom-cust-preview.png" },
  { id: "s06", label: "Restaurant local", kind: "HoReCa", from: "#3a1c0b", to: "#f5a623", layout: "hero", src: "/images/portfolio-previews/hieu-bowl-preview.png" },
  // Real, shipped client site — same screenshot VideoShowcase/Works use as
  // this project's poster frame (see portfolio.js).
  { id: "s07", label: "ProLinen HORECA", kind: "Website B2B", from: "#1c1c22", to: "#9aa3b2", layout: "editorial", src: "/showcase/prolinen-poster.jpg" },
