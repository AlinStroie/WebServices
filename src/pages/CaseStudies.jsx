...
/**
 * /studii-de-caz — placeholder landing for the future case-studies index.
 * The homepage's case-study spotlight CTA routes here already; this page
 * just needs to exist and not 404 until the real index is designed.
 */
function CaseStudies() {
  return (
    <div className="grad-dark replica flex min-h-dvh w-full flex-col items-center justify-center gap-6 px-6 text-center">
      <SEO
        title="Studii de caz"
        description="Studiile de caz A Squared Studio — în lucru."
      />
      ...
      <h1 className="display title-gradient text-[clamp(2rem,4vw,3rem)]">
        Studiile de caz vin în curând
      </h1>

      <p className="max-w-[46ch] text-[15px] leading-relaxed text-[color:var(--color-copy-on-dark)]">
        Lucrăm la pagina dedicată fiecărui proiect: obiectiv, proces și
        rezultate concrete. Până atunci, poți vedea proiectele în secțiunea
        Lucrări sau ne poți scrie direct.
      </p>
